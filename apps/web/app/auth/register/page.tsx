      ...
      >
        ...
        <form className="space-y-5" onSubmit={handleRegister}>
          ...
          <button
            type="submit"
            disabled={loading}
            className={`w-full font-medium py-3 rounded-xl transition-all shadow-[0_0_20px_rgba(147,51,234,0.3)] mt-4 ${
              loading ? "bg-purple-600/50 text-purple-200 cursor-not-allowed" : "bg-purple-600 hover:bg-purple-500 text-white"
            }`}
          >
            {loading ? "Connecting to Supabase..." : "Sign Up via Supabase"}
          </button>
        </form>
