...
import { Zap, Home, Users, Search, BrainCircuit, Database, CreditCard, LogOut, User } from "lucide-react";
            ...
            {!loading && user ? (
              ...
              <>
                ...
                <button
                  ...
                  className="text-sm text-slate-400 hover:text-rose-400 transition-colors p-2 rounded-full hover:bg-slate-800/50"
                  title="Sign out"
                >
